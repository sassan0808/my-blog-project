...
export const projects: Project[] = [
  {
    ...
    description: 'AI技術を活用して、企業の業務を副業人材向けに最適化するサポートツール。業務の切り出しから、マッチング、進捗管理までをワンストップで支援。制作期間：2日 ※モック版',
    longDescription: 'パーソルイノベーション株式会社のlotsfulサービスと連携し、企業が副業人材を効果的に活用できるようサポートするプラットフォームです。AI分析により、業務の切り出しを最適化し、適切な人材とのマッチングを実現します。※あくまでモック版であり、実際のサービスとは異なります。',
    technologies: ['Next.js', 'TypeScript', 'Supabase', 'Tailwind CSS', 'Framer Motion', 'Zustand', 'Gemini API', 'Web Speech API'],
    liveUrl: 'https://lotsful-ai-engine.vercel.app/',
    featured: true,
  ...
  },
  {
    ...
    liveUrl: 'https://kokone-journal.vercel.app/',
    featured: true,
  ...
  },
  {
    id: '3',
    title: 'AI小説リーダー',
    description: 'AIが作成した小説を読むことができるリーダーアプリ。GeminiCLIで作成。制作期間：1日',
    longDescription: 'AIによって生成された小説作品を読むためのリーダーアプリケーションです。SF、ファンタジー、ミステリーなど様々なジャンルのAI小説を収録し、快適な読書体験を提供します。AIならではの独創的な物語や、人間では思いつかないような展開を楽しむことができます。GeminiCLIを使用して効率的に開発しました。',
    technologies: ['HTML', 'CSS', 'JavaScript', 'Responsive Design', 'GeminiCLI'],
    liveUrl: 'https://ai-shosetsu-miroku-9xqi.vercel.app/',
    featured: true,
