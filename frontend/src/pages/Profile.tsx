    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <Card className="bg-gray-900/50 backdrop-blur-sm border-gray-800 p-8 lg:p-12">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <Card className="bg-gray-900/50 backdrop-blur-sm border-gray-800 p-8 lg:p-12">
            <p className="text-lg text-gray-300 leading-relaxed">
              本業は、パーソルイノベーション株式会社「lotsful」のアカウントコンサルタントとして、この変革期だからこそ必要な「民主化されたAIからの情報だけではなく、実践知の共有」を可能にする副業/兼業マッチングという選択肢をご提案しています。
            </p>
          </Card>
        </div>
      </section>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <Card className="bg-gray-900/50 backdrop-blur-sm border-gray-800 p-8 lg:p-12">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              専門的な知見をもつ方々より登録していただいたデータベースを必要なタイミングでご活用いただけるサービス設計になっており、初期費用不要で人材にアクセスが可能です。
            </p>
          </Card>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {careerHighlights.map((career, index) => (
              <Card 
                key={index}
                className="bg-gray-900/50 backdrop-blur-sm border-gray-800 p-6 hover:border-gray-700 transition-colors"
              >
                <div className="text-center mb-4">
                  <span className="text-4xl">{career.icon}</span>
                </div>
                <h3 className="text-xl font-semibold text-white mb-3">{career.company}</h3>
                <p className="text-gray-400 text-sm leading-relaxed">{career.roles}</p>
              </Card>
            ))}
          </div>
        </div>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <Card className="bg-gradient-to-r from-blue-900/30 to-purple-900/30 backdrop-blur-sm border-gray-800 p-8 lg:p-12">
            <h2 className="text-3xl sm:text-4xl font-bold mb-8 text-center">
              <span className="bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
                ご相談・情報交換のお誘い
              </span>
            ...
            <p className="text-lg text-gray-300 leading-relaxed mb-10 text-center">
              対話形式でぜひお気軽に情報交換の機会をいただけたらと思います！
            </p>
