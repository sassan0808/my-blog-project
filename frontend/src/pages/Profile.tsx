    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <Card className="bg-gray-800/80 backdrop-blur-sm border-gray-700 p-8 lg:p-12">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <Card className="bg-gray-800/80 backdrop-blur-sm border-gray-700 p-8 lg:p-12">
            <p className="text-lg text-gray-200 leading-relaxed">
              本業は、<span className="text-white font-semibold">パーソルイノベーション株式会社</span>「lotsful」のアカウントコンサルタントとして、この変革期だからこそ必要な「民主化されたAIからの情報だけではなく、実践知の共有」を可能にする副業/兼業マッチングという選択肢をご提案しています。
            </p>
          </Card>
        </div>
      </section>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <Card className="bg-gray-800/80 backdrop-blur-sm border-gray-700 p-8 lg:p-12">
            ...
            <p className="text-lg text-gray-200 leading-relaxed">
              <span className="text-white font-semibold">パーソルイノベーション株式会社</span>が提供する専門的な知見をもつ方々より登録していただいたデータベースを必要なタイミングでご活用いただけるサービス設計になっており、初期費用不要で人材にアクセスが可能です。
            </p>
          </Card>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {careerHighlights.map((career, index) => (
              <Card 
                key={index}
                className="bg-gray-800/80 backdrop-blur-sm border-gray-700 p-6 hover:border-gray-600 transition-colors"
              >
                <div className="text-center mb-4">
                  <span className="text-4xl">{career.icon}</span>
                </div>
                <h3 className="text-xl font-semibold text-white mb-3">{career.company}</h3>
                <p className="text-gray-300 text-sm leading-relaxed">{career.roles}</p>
              </Card>
            ))}
          </div>
        </div>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <Card className="bg-gradient-to-r from-blue-800/40 to-purple-800/40 backdrop-blur-sm border-gray-700 p-8 lg:p-12">
            <h2 className="text-3xl sm:text-4xl font-bold mb-8 text-center">
              <span className="bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
                ご相談・情報交換のお誘い
              </span>
            ...
            <div className="space-y-4 mb-10">
              <p className="text-lg text-gray-200 flex items-start">
            ...
            <p className="text-lg text-gray-300 leading-relaxed mb-10 text-center">
              <span className="text-white font-semibold">パーソルイノベーション株式会社</span>での活動や、対話形式でぜひお気軽に情報交換の機会をいただけたらと思います！
            </p>
